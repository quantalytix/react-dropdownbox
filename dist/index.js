...
var ReactDropdownContext = React__default.createContext();
...
function SearchBox(_ref) {
  ...
  var context = React.useContext(ReactDropdownContext);
  ...
  return React__default.createElement(
    ...
    React__default.createElement('input', { className: context.showResult ? 'input-box' : 'input-box show', ref: input, placeholder: placeholder, onChange: handleChange, tabIndex: '0' }),
    React__default.createElement(
      'div',
      { className: 'dropdown-icon', tabIndex: '-1' },
      icon ? React__default.createElement('div', { className: icon }) : React__default.createElement(
        'div',
        { className: 'arrows' },
        React__default.createElement('i', { className: 'arrow-down2' })
      )
    )
  );
}
...
function DropdownItem(_ref) {
  ...
  var _useContext = React.useContext(ReactDropdownContext),
  ...
  var renderDropdown = function renderDropdown() {
    ...
    return list.map(function (item, key) {
      if (item.children && item.children.length) {
        ...
        return React__default.createElement(DropdownItem, { key: item.node, item: item });
      }
    });
  };
...
function ReactDropdown(_ref) {
  ...
  var _useState = React.useState(initialState.textInput),
      _useState2 = slicedToArray(_useState, 2),
      textInput = _useState2[0],
      setTextInput = _useState2[1];

  var _useState3 = React.useState(initialState.selectedIndex),
      _useState4 = slicedToArray(_useState3, 2),
      selectedIndex = _useState4[0],
      setSelectedIndex = _useState4[1];

  var _useState5 = React.useState(initialState.selectedKey),
      _useState6 = slicedToArray(_useState5, 2),
      selectedKey = _useState6[0],
      setSelectedKey = _useState6[1];

  var _useState7 = React.useState(initialState.activeIndex),
      _useState8 = slicedToArray(_useState7, 2),
      activeIndex = _useState8[0],
      setActiveIndex = _useState8[1];

  var _useState9 = React.useState(initialState.itemStack),
      _useState10 = slicedToArray(_useState9, 2),
      itemStack = _useState10[0],
      setItemStack = _useState10[1];

  var _useState11 = React.useState(initialState.count),
      _useState12 = slicedToArray(_useState11, 2),
      count = _useState12[0],
      setCount = _useState12[1];

  var _useState13 = React.useState(initialState.internalData),
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      React__default.createElement(SearchBox, otherProps),
      React__default.createElement(ResultsContainer, null)
    )
  );
}
